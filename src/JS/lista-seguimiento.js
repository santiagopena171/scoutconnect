    ...
    return `
      <div class="watchlist-player-card" onclick="watchlistManager.showPlayerProfile('${player.id}')"
        ...
        <div class="watchlist-player-actions">
          <button class="btn btn-primary btn-sm" onclick="event.stopPropagation(); watchlistManager.showPlayerProfile('${player.id}')" title="Ver Perfil">
            <i class="fas fa-eye"></i>
          </button>
          <button class="btn btn-remove btn-sm" onclick="event.stopPropagation(); watchlistManager.removeFromWatchlist('${player.id}')" title="Quitar de seguimiento">
